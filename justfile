...
# Fresh-install the environment-selected blackbox exporter and apply its Probes.
observability-blackbox-install env='':
    @scripts/observability_blackbox.sh install '{{ env }}'

# Upgrade the environment-selected blackbox exporter and apply its Probes.
observability-blackbox-upgrade env='':
    @scripts/observability_blackbox.sh upgrade '{{ env }}'

# Summarize the environment-selected blackbox resources (read-only).
