...
export SUGARKUBE_MDNS_ABSENCE_TIMEOUT_MS := env('SUGARKUBE_MDNS_ABSENCE_TIMEOUT_MS', '20000')
export SUGARKUBE_MDNS_ABSENCE_BACKOFF_START_MS := env('SUGARKUBE_MDNS_ABSENCE_BACKOFF_START_MS', '250')
export SUGARKUBE_MDNS_ABSENCE_BACKOFF_CAP_MS := env('SUGARKUBE_MDNS_ABSENCE_BACKOFF_CAP_MS', '2000')
export SUGARKUBE_MDNS_ABSENCE_ATTEMPTS := env('SUGARKUBE_MDNS_ABSENCE_ATTEMPTS', '10')
export SUGARKUBE_MDNS_ABSENCE_JITTER := env('SUGARKUBE_MDNS_ABSENCE_JITTER', '0.25')
export SUGARKUBE_MDNS_ABSENCE_REQUIRED_CONSEC := env('SUGARKUBE_MDNS_ABSENCE_REQUIRED_CONSEC', '2')
