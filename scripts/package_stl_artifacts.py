...
def package_stl_artifacts(*, stl_dir: Path, out_dir: Path) -> None:
    ...
    artifacts = {
        "pi_cluster_stack": {
            ...
            "intro": "Modular stack plates, posts, and fan adapters with documented fan sizes.",
            "layout": {
                "printed": [
                ...
                "shared": [
                    stl_dir / "pi_cluster/pi_carrier_stack_post.stl",
                    stl_dir / "pi_cluster/pi_carrier_stack_fan_adapter.stl",
                ],
                "fan_walls": sorted(
                    (stl_dir / "pi_cluster").glob("pi_carrier_stack_fan_wall_fan*.stl")
                ),
                "preview": [
                    stl_dir / "pi_cluster/pi_carrier_stack_preview_assembly.stl",
                ],
            },
            "docs": [
