...
def environment_contract(environment)
  environment == "staging" ? ["staging", "sugarkube-int"] : ["prod", "sugarkube-prod"]
end
...
label_environment, cluster = environment_contract(environment)
...
cloudflare_matchers = ['alertname="CloudflareTunnelNoHealthyConnections"', "environment=\"#{label_environment}\"",
                       "cluster=\"#{cluster}\"", 'severity="critical"']
