...
def provision_node(archive: Path, root: Path, apply: bool) -> int:
    ...
    # The archive can declare a loader that is unavailable to this userspace.
    # Prove the selected root's loader before any destination publication.
    ...
    with tarfile.open(archive, "r:xz") as bundle:
        ...
        with tempfile.NamedTemporaryFile() as candidate:
            ...
            runtime.validate_node_elf(Path(candidate.name), contract)
    if not apply:
    ...
    with tarfile.open(archive, "r:xz") as bundle:
        ...
        try:
            ...
            runtime.validate_node_elf(temporary, contract)
