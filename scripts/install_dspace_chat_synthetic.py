...
def classification_runtime_directory_preserved(tree: Path) -> bool:
    """Report whether an asset opts into persistent classification runtime state."""
...
def validate_current_candidate(tree: Path) -> dict[str, str]:
    """Validate a newly rendered asset against the complete current policy."""
...
def status(root: Path) -> int:
    ...
    preserved = "yes" if classification_runtime_directory_preserved(retained) else "no"
    print(f"classificationRuntimeDirectoryPreserved={preserved}")
