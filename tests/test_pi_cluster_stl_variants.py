...
def test_scad_to_stl_workflow_uploads_grouped_artifacts() -> None:
    """The STL workflow should publish grouped artifacts alongside the legacy bundle."""
