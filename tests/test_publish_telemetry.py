...
def test_collect_os_release_missing_file(monkeypatch):
...
def test_discover_verifier_path_skips_blank_candidates(monkeypatch):
    monkeypatch.delenv("SUGARKUBE_TELEMETRY_VERIFIER", raising=False)
