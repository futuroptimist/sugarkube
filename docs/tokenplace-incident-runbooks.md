...
The runner and its live quota preflight use only Python's standard library. Its small, strict JSON
projection of the token.place Probe coordinates is committed at
