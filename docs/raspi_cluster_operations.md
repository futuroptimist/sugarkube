...
The dspace chart exposes `DSPACE_ENV` via the top-level `environment` field in the values
files. In this repo, `docs/examples/dspace.values.dev.yaml` sets `environment: dev` and
