...
- [observability-design.md](observability-design.md) — canonical cross-application Prometheus/Grafana design, metrics contract, dashboards, alerts, and phased deployment
