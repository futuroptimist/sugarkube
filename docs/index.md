...
- [design/tokenplace-static-429-boundary-emulation.md](design/tokenplace-static-429-boundary-emulation.md) — staging-only design for a future static HTTP-429 boundary-emulation workflow
...
- [design/static-429-boundary-emulation.md](design/static-429-boundary-emulation.md) — design-only,
  staging-only static HTTP-429 boundary emulation, separate from quota exhaustion
