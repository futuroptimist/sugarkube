...
| M3 × 90–110 mm bolts + washers + nuts | 4 | Clamp the plates and posts together. Length depends on `levels`, `z_gap_clear`, plate thickness, and how much nut-trap depth you use on the post. M3-0.5 hardware recommended. |
...
- **Stack clamp:** four long M3 bolts + washers + nuts (or nut traps in the posts).
