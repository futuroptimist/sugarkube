...
Do not invent real configs for future apps such as `wove` until their app repos have the required image and chart details. jobbot3000 and GitShelves are now onboarded because their image and chart details are known. Capture these answers first:
