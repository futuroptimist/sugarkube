...
| `scripts/cloud-init/export-kubeconfig.sh` | Export sanitized/full kubeconfigs and the k3s node token to `/boot/`. | [Pi Image Quickstart](./pi_image_quickstart.md) §3 | Runs from cloud-init during first boot. |
