...
- Public availability: blackbox probes for `https://staging.democratized.space/`, `/config.json`, `/healthz`, `/livez`, and production equivalents are defined in `monitoring/probes/public-apps.yaml`.
