...
3. **Blackbox monitoring**: *implemented in staging.* 21 public probes across all five apps plus TLS expiry are declared and scripted-verified, per [`docs/observability-blackbox.md`](./observability-blackbox.md). GitShelves remains excluded from the WAN dependency-loss drill until its external route and workload are live.
