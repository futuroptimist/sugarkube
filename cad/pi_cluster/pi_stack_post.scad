...
boss_h = max(stack_pocket_depth - 0.1, stack_pocket_depth * 0.75);
post_body_h = z_gap_clear - boss_h * 2;
...
assert(post_body_h > 0, "z_gap_clear must exceed the total boss stack height");
