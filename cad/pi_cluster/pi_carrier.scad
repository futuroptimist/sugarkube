...
stack_pocket_d = is_undef(stack_pocket_d) ? 9.0 : stack_pocket_d;
stack_pocket_depth_input =
    is_undef(stack_pocket_depth) ? min(plate_thickness / 2 - 0.1, 1.2) : stack_pocket_depth;
